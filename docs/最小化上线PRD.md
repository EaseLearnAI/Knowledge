...
> 收藏 B 站、小红书、抖音视频，Memo 自动提取音频、总结重点，沉淀成你的知识库。
...
- 展示分散的 B 站、小红书、抖音收藏，逐渐汇入 Memo 的知识卡片；
...
> 把 B 站、小红书、抖音等视频链接发到 Memo，自动提取音频，生成摘要、关键观点和标签，沉淀进你的知识库。

**画面建议**：

- 用三段式过程表达：`视频链接 → 自动分析 → 知识卡片`；
